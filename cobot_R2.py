...
def ConnectToCB(ip):
    ...
    if cmd_connect == 0 & data_connect == 0:
        ...
        DATAREQ_THREAD_R2 = threading.Thread(target=ReqDataStart, args=(DATASock,))
        CMDREAD_THREAD_R2 = threading.Thread(target=ReadCMD, args=(CMDSock,))
        DATAREAD_THREAD_R2 = threading.Thread(target=ReadDATA, args=(DATASock,))
        DATAREQ_THREAD_R2.start()
        CMDREAD_THREAD_R2.start()
        DATAREAD_THREAD_R2.start()
